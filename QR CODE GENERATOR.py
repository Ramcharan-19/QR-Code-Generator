...
root.configure(bg='Turquoise')  # Set background color for the main window

note = ttk.Notebook(root)
note.pack()

frame1 = Frame(note, height=400, width=150, bg='black')  # Set background color to black
frame1.pack(fill="both", expand=True)
frame2 = Frame(note, height=400, width=150, bg='black')  # Set background color to black
...
canvas1 = Canvas(frame1, width="400", height="300", relief=RIDGE, bd=2, bg='white')  # Set canvas background to white
canvas1.pack(padx=10, pady=10)

canvas2 = Canvas(frame2, width="400", height="400", relief=RIDGE, bd=2, bg='white')  # Set canvas background to white
...
def generate():
    if data_entry.get() != '' and save_entry.get() != '':
        ...
        info = Label(frame1, text="Generated QR code:", font=('ariel 15 bold'), bg='black', fg='gold')  # Set text color to gold
        ...
        info = Label(frame1, text="Please enter the data for QR code", font=('ariel 15 bold'), bg='black', fg='gold')  # Set text color to gold
...
data_label = Label(frame1, text='Enter data:', font=('ariel 15 bold'), bg='black', fg='gold')  # Set text color to gold
data_label.place(x=61, y=330)

save_label = Label(frame1, text='Enter name \n to save with:', font=('ariel 15 bold'), bg='black', fg='gold')  # Set text color to gold
